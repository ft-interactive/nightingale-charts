...
},{"./../../bower_components/d3/d3.js":undefined}],2:[function(require,module,exports){
'use strict'
...
},{"./../../bower_components/d3/d3.js":undefined}],3:[function(require,module,exports){
module.exports = {
...
},{"./category.js":1,"./date.js":2,"./value.js":4}],4:[function(require,module,exports){
'use strict'
...
},{"./../../bower_components/d3/d3.js":undefined}],5:[function(require,module,exports){
'use strict';
var d3 = require("./../../bower_components/d3/d3.js");
...
},{"./../../bower_components/d3/d3.js":undefined}],6:[function(require,module,exports){
module.exports = {
...
var valueAxis = require('../axis/value.js');
...
function lineChart(p) { 
	...
	function buildModel(opts) {
		...
		m.x = normaliseSeriesOptions(m.x);
		m.y = normaliseYAxisOptions(m.y)
							.filter(function (d) {
								return !!d.key && d.key !== m.x.key;
							})
							.map(function (d, i) {
								d.index = i;
		...
		m.data = !Array.isArray(m.data) ? [] : m.data.map(function (d) {
			...
			d[m.x.key] = m.dateParser ? m.dateParser( s ) : null;
			if(d[m.x.key] === null) {
				m.error({
					node: null,
	...
	//position stuff
		...
		if (model.key) {
			var entries = model.y.map(function (d) {
...
//				.orient( model.valueAxisOrient )
		...
		function x(d) {
			return timeScale ( d[model.x.key] );
		}
		...
		var i = model.y.length;

		while (i--) {
			drawline(lines, model.y[i]);
		}
...
},{"../axis/date.js":2,"../axis/value.js":4,"../element/line-key.js":9,"../element/text-area.js":10,"./../../bower_components/d3/d3.js":undefined}],8:[function(require,module,exports){
'use strict';
var d3 = require("./../../bower_components/d3/d3.js");
...
},{"./../../bower_components/d3/d3.js":undefined}],9:[function(require,module,exports){
'use strict'
...
},{"./../../bower_components/d3/d3.js":undefined}],10:[function(require,module,exports){
...
},{"./../../bower_components/d3/d3.js":undefined}],11:[function(require,module,exports){
...
},{"./../../bower_components/d3/d3.js":undefined}],"d3":[function(require,module,exports){
!function() {
  var d3 = {
    version: "3.4.13"
  };
...
},{"./axis/index.js":3,"./chart/index.js":6,"./element/line-key.js":9,"./element/text-area.js":10,"./util/chart-attribute-styles.js":11}]},{},["o-charts"]);
